...
const links = ["services", "technology", "industries", "solutions", "locations", "adobe-commerce", "shopify", "woocommerce", "bigcommerce", "ms-business-central", "ms-integrations", "ms-erp", "ms-industries", "ms-finance", "ms-others"];
links.forEach(link => {
