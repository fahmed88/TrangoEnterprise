...
<?php get_header('header'); ?>
    ...
    <section class="animated-row section salesforce-banner dynamics-integration-banner microsoft-power-bi-banner no-lzl-section">
        <div class="container">
            <div class="text-cont">
                <h1>
...
<?php
    $process_tab_heading = get_field('process_tab_heading');
    $process_tab_content = get_field('process_tab_content');
    $processtab = [
        'title'      =>$process_tab_heading,
        'content'    =>$process_tab_content,
        'category'   =>'microsoft-power-bi',
        'orderr'      =>'ASC',
    ];
    get_template_part('template-parts/global/process-icon-tab-new','',$processtab);
?>
            ...
            <div class="row">
                <div class="col-md-6">
                    <h2 class="section-title" data-aos="fade-left" data-aos-duration="1500">
                        <?php if(get_field('sharepoint_section_subtitle')) : ?>
                        <span><?php echo get_field('sharepoint_section_subtitle'); ?></span>
                        <?php endif;?>

                        <?php echo get_field('sharepoint_section_title'); ?>
                    </h2>
                </div>
                <div class="col-md-6">
                    <p class="section-content mb-0">
                        <?php echo get_field('sharepoint_section_description'); ?>
                    </p>
                </div>
            </div>
        </div>
...
section.salesforce-banner .text-cont {
    ...
    background: linear-gradient(257.35deg, #444341 1.18%, #F2CA12 73.32%);
}
.portfolio-slides-full-sec .retailer .counter-box {
    background: rgba(88, 82, 60, 0.54);
}

.portfolio-slides-full-sec .educational {
    background: linear-gradient(257.35deg, #103B54 1.18%, #087281 73.32%);
}

.portfolio-slides-full-sec .educational .counter-box {
    background: rgba(15, 60, 85, 0.54);
}
