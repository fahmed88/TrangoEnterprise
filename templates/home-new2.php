<?php /*
Template Name: Microsoft New2
*/ ?>
<?php get_header('header'); ?>

   
    <!-- BANNER SECTION START -->
    <section class="animated-row section salesforce-banner ms-home-banner">
        <div class="container">
            <div class="text-cont">
                <h1 class="text-capitalize" data-aos="fade-right" data-aos-duration="1000">
                     <?php echo get_field('banner_title'); ?>
                </h1>
                <p data-aos="fade-left" data-aos-duration="1000">
                   <?php echo get_field('banner_content'); ?>
                </p>
				<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#next-project-modal" data-aos="fade-left" data-aos-duration="1000"><?php echo get_field('banner_button_text'); ?></button>
            </div>
            <div class="ms-banner-video" data-aos="fade-up"  data-aos-duration="2000">
                ...
                <a href="javascript:void(0)"> <button class="ms-video-btn">
...
?>
    ...
    <div class="col-md-12 mb-4 <?php echo ( $counter % 3 == 1 ) ? 'col-lg-4' : ( ( $counter % 3 == 2 && $counter != $total_posts ) ? 'col-lg-8' : 'col-lg-4' ); ?>">
        <div class="offer-box sharepoint" data-aos="fade-right" data-aos-duration="1000">
            <img src="<?php echo $featured_image_url; ?>" alt="share point" class="img-fluid" lazy="loading">
            <div class="content-box">
                <h3><?php echo get_the_title(); ?></h3>
                <p><?php echo get_the_content(); ?></p>
                <a href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#next-project-modal">LEARN MORE</a>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-12 col-lg-8 mb-4">
        <div class="offer-box ms-dynamic-365" data-aos="fade-left" data-aos-duration="1000">
            <div class="row align-items-center">
                ...
                <div class="col-md-6">
                    <img src="<?php echo $featured_image_url; ?>" alt="microsoft dynamics365" class="img-fluid" lazy="loading">
                </div>
            </div>
        </div>
    </div>
...
wp_reset_query(); ?>
                    ...
                    <div class="col-12">
                       <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#next-project-modal" data-aos="fade-right" data-aos-duration="1000"><?php echo get_field('services_button_text'); ?></button>
                    </div>
                </div>
            </div>
        </div>
