<?php
/*
    Template Name: Dynamics Shopify Integration
        ...
        <div class="row">
            <div class="col-lg-6 col-md-12">
                <div class="text-cont">
                    ...
                    <?php if (is_array($cta)) : ?>
                        <div class="square">
                            <a href="<?php echo $cta['url']; ?>" class="square-pulse btn btn-red text-capitalize" <?php echo is_modal_link($cta['url']); ?>>
                                <?php echo $cta['title']; ?>
                            </a>
                        </div>
                    <?php endif; ?>
...
<section class="section ms-common-erp-challenges-section ms-shopify-integ-challenges-section">
    <div class="container">
        <div class="text-content text-center mb-4">
...
<hr class="my-0 mx-2 mx-lg-5" style="background-color: rgb(0 0 0 / 60%);">
...
$faqs = [
    ...
    'category' => 'dynamics-shopify-integration',
    'bg_class' => 'bg-gray',
    'show_search' => false
];
