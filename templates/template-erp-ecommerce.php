<?php
/*
    Template Name: Dynamics ERP ecommerce
...
<!-- BANNER SECTION START -->
 ...
 ?>
<section class="section business-central-integration-banner erp-ecommerce-banner no-lzl-section">
    <div class="container">
...
<section class="section ecommerce-platform-integrations pb-5">
    <div class="container">
        <div class="text-cont text-center">
            <h2 class="section-title">
                <?php echo get_field('integration_section_title'); ?>
            </h2>
            <p class="section-content text-center">
                <?php echo get_field('integration_section_description'); ?>
            </p>
        </div>

        <!-- Ecommerce Platform Integrations -->
        <div class="integration-cards">
            <h3>Ecommerce Platform <span>Integrations</span></h3>
            <div class="row gy-4">
                <?php if (have_rows('ecommerce_platform_integrations')): ?>
                    <?php while (have_rows('ecommerce_platform_integrations')): the_row(); ?>
                        <?php 
                            $image = get_sub_field('platform_image');
                            $title = get_sub_field('platform_title');
                            $desc  = get_sub_field('platform_description');
                            $class = get_sub_field('platform_class');
                        ?>
                        <div class="col-lg-4 col-md-6">
                            <div class="card <?php echo esc_attr($class); ?>">
                                ...
                                <div class="text-content">
                                    <span class="title d-block"><?php echo esc_html($title); ?></span>
        ...
        <div class="integration-cards">
            <h3>Marketplace <span>Integrations</span></h3>
            <div class="row gy-4">
                <?php if (have_rows('marketplace_integrations')): ?>
                    <?php while (have_rows('marketplace_integrations')): the_row(); ?>
                        <?php 
                            $image = get_sub_field('marketplace_image');
                            $title = get_sub_field('marketplace_title');
                            $desc  = get_sub_field('marketplace_description');
                            $class = get_sub_field('marketplace_class');
                        ?>
                        <div class="col-lg-4 col-md-6">
                            <div class="card <?php echo esc_attr($class); ?>">
                                <div class="img-content">
...
<section class="section dynamic-365-solutions erp-implementation-solutions erp-ecommerce-solutions pb-5 pt-0">
    <div class="container">
        <div class="row gy-4">
                    ...
                    <div class="col-lg-6 col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <span class="card-title d-block"><?php echo get_sub_field('d365_card_title'); ?></span>
                            </div>
                            <div class="card-body">
...
<section class="section microsoft-ecosystem mb-5">
    <div class="container">
        <div class="text-cont text-center">
            <h2 class="section-title">
                <?php echo get_field('microsoft_ecosystem_title'); ?>
            </h2>
            <p class="section-content text-center">
                <?php echo get_field('microsoft_ecosystem_subtitle'); ?>
            </p>
        </div>

        <?php if( have_rows('microsoft_ecosystem_cards') ): ?>
            <div class="row gy-4">
                <?php while( have_rows('microsoft_ecosystem_cards') ): the_row(); 
                    $image = get_sub_field('microsoft_ecosystem_card_image');
                    $title = get_sub_field('microsoft_ecosystem_card_title');
                    $desc  = get_sub_field('microsoft_ecosystem_card_desc');
                ?>
                <div class="col-lg-6">
                    <div class="card">
                        <div class="left">
                            <?php if($image): ?>
                                <img src="<?php echo esc_url($image['url']); ?>" alt="<?php echo esc_attr($title); ?>" class="img-fluid">
                            <?php endif; ?>
                        </div>
                        <div class="right">
...
<section class="section key-benefits">
    <div class="container">
        <div class="text-cont text-center">
            <h2 class="section-title">
                <?php echo get_field('erp_key_benefits_title'); ?>
            </h2>
            <p class="section-content text-center">
                <?php echo get_field('erp_key_benefits_subtitle'); ?>
            </p>
        </div>
    </div>

    <div class="container-fluid p-0">
        <?php if (have_rows('erp_key_benefits_slider')): ?>
            <div class="owl-carousel owl-theme key-benefits-slider">
                <?php while (have_rows('erp_key_benefits_slider')): the_row(); ?>
                    <div class="item">
                        <div class="card">
                            ...
                            <div class="text-box">
                                <h3><?php echo get_sub_field('erp_key_benefits_card_title'); ?></h3>
                                <p><?php echo get_sub_field('erp_key_benefits_card_desc'); ?></p>
                            </div>

                            <div class="example-box">
                                <p class="example-title"><?php echo get_sub_field('erp_key_benefits_example_heading'); ?></p>
                                <p class="example-text"><?php echo get_sub_field('erp_key_benefits_example_text'); ?></p>
                            </div>
...
<section class="section roi-analysis">
    <div class="container">
        <div class="text-cont text-center">
            <h2 class="section-title">
...
<section class="section why-business-central cost-key-factors legacy-healthcare-erps bg-gray">
    <div class="container">
        <div class="text-cont text-center mb-3">
            <h2 class="section-title">
        ...
        <div class="row gy-4">
            <?php if (have_rows('ps_cards')): ?>
                <?php while (have_rows('ps_cards')): the_row(); ?>
                    <div class="col-lg-4">
                        <div class="card offWhite-bg border-0">
...
<?php get_footer(); ?>
<style>
.key-benefits-slider .owl-dots.disabled{
