...
<body class="<?php echo @$args['class']; ?>">
    ...
    <div class="vertical-scroll-but s">
 ...
 header("Cache-Control: no-store, no-cache, must-revalidate, max-age=0");
            ...
            ?>
                <a href="tel:<?php echo $is_special ? htmlspecialchars($special_number) : htmlspecialchars($default_number); ?>"><span id="dynamic-phone"><?php echo $is_special ? htmlspecialchars($special_number) : htmlspecialchars($default_number); ?></span>
                ...
                <div class="header-inner">
                    ...
                    <nav class="navbar navbar-expand-lg">
                        <div class="container-fluid">
                            <img src="<?php echo get_template_directory_uri() ?>/assets/img/share-point/microsftlogo.webp" alt="square" class="img-fluid">
