...
function testimonials_post_type() {
    $labels = array(
        ...
        'add_new' => _x('Add New Testimonials', 'Team Member'),
    ...
    register_post_type( 'testimonials_tabs' , $args );
}
...
function testimonials_taxonomies() {
    ...
    register_taxonomy( 'testimonials_categories', array( 'testimonials_tabs' ), $args );
}
