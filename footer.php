...
<?php get_template_part('template-parts/global/select-country');?>
    <!-- FOOTER SECTION START -->
    <div class="footer-wrapper">
       
    <section class="animated-row section contact-section pb-0 pt-0">
            <div class="container">
                <div class="row">
                    <div class="col-md-8">
                        ...
                        <?php              
                            ...
                            ?> 
                            <h2 data-aos="fade-down" data-aos-duration="1000">Driving Change <br/>
                        ...
                        ?> 
                            <a href="<?php echo get_field('button_url') ;?>" class="footer-cta-btn">
                            <?php echo get_field('button_text') ;?> <svg width="33" height="24" viewBox="0 0 33 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M10.8304 17L16.2457 12L10.8304 7" stroke="#DE253A" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                    <path d="M17.3287 17L22.744 12L17.3287 7" stroke="#DE253A" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                    </svg>
                            </a>
                        <?php              
                        }else {
                            ?> 
                            <a href="https://trangotech.com/connect-with-us/" class="footer-cta-btn mt-3">
                            Contact Us <svg width="33" height="24" viewBox="0 0 33 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M10.8304 17L16.2457 12L10.8304 7" stroke="#DE253A" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                    <path d="M17.3287 17L22.744 12L17.3287 7" stroke="#DE253A" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                    </svg>
                            </a>
                    ...
                    <div class="col-md-4 text-md-end" data-aos="flip-right" data-aos-duration="1000">
                    <?php if(get_field('right_image')){  
                      ?> 
                        <img src="<?php echo get_field('right_image') ;?>" class="img-fluid h-100" />
                      <?php              
                    }else {
                        ?> 
                        <img src="<?php echo get_template_directory_uri();?>/assets/img/footer-logo.webp" class="img-fluid h-100" alt="CTA Logo" loading="lazy" />
                        <?php
                    }?>
        ...
        <footer>
            ...
            <div class="row">
                    <div class="footer-menu">
                        <?php
                            echo file_get_contents($navigations_path . 'footer-mobile.txt');
                            echo file_get_contents($navigations_path . 'footer-staff-augmentation.txt');
                            echo file_get_contents($navigations_path . 'footer-microsoft.txt');
                            echo file_get_contents($navigations_path . 'footer-ecommerce.txt');
                            echo file_get_contents($navigations_path . 'footer-solutions.txt');
                            echo file_get_contents($navigations_path . 'footer-bpo.txt');
                        ?>
                    </div>
                </div>
                <div class="row">
                    <?php echo file_get_contents($navigations_path . 'footer-secondary-microsoft.txt'); ?>
                </div>
                <?php echo file_get_contents($navigations_path . 'footer-locations.txt'); ?>

                <div class="row copyright-sec">
                    <div class="col-md-12">
                        <p class="copyright-text">Copyright © <?php echo date("Y"); ?> <a href="https://trangotech.com/">Trango Tech Limited</a></p>
                    </div>
                </div>
            </div>
        </footer>
    ...
    <div class="financial-modal-dialog ">
        ...
        <div class="financial-modal-content">
            ...
            <div class="financial-modal-body">
                <div class="text-cont">
                    <p class="estimate-app-title mb-0">Estimate Your BC</p>
...
<script src="<?php echo get_template_directory_uri()?>/assets/js/footer-menu.js"></script>
</main>
</body>
</html>
