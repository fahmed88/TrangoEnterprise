        ...
        <div class="container">
            ...
            if ($the_query->found_posts!=0)
            {
                ...
                while ( $the_query->have_posts() ) : $the_query->the_post();
                    ...
                    ?>
                    <li class="nav-item">
                        <a id="tab-<?php echo $i; ?>" href="#pose-<?php echo $i; ?>" class="nav-link <?php echo $i==1 ? 'active' : '' ?>" data-bs-toggle="tab" role="tab"><span><img src="<?php echo  $feat_image ; ?>"></span> &nbsp;<?php echo  $erp_title; ?></a>
                    </li>
                    <?php
                        $i++;
                    endwhile;
