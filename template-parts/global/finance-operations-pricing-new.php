...
<section class="section finance-and-operations-pricing erp-supply-chain-pricing <?php echo $class; ?>">
    <div class="container">
        ...
        <?php endif; ?>
         <?php if (have_rows('pricing_bottom_sec')): ?>
<div class="bottom-wrapper">
            <div class="row">
                <?php while (have_rows('pricing_bottom_sec')): the_row(); ?>
                <div class="col-lg-3 col-md-6">
                    <div class="box">
                        <p class="pric-bottom-title mb-1"><?php echo get_sub_field('pricing_bottom_heading'); ?></li></h3>
                        <span><?php echo get_sub_field('pricing_bottom_pricingg'); ?></span>
                        <p><?php echo get_sub_field('pricing_bottom_text'); ?></p>
                    </div>
                </div>
                <?php endwhile; ?>
        ...
        <div class="fact">
            <ul>
                <li>
                    <img src="<?php echo get_field('pricing_bottom_cta_imagess'); ?>" alt="fact" class="img-fluid">
                </li>
                <li>
                    <span class="fact-title"><?php echo get_field('pricing_bottom_cta_text'); ?></span>
                </li>
                <li>
                    <p><?php echo get_field('pricing_bottom_cta_description'); ?></p>
                </li>
            </ul>
        </div>
    </div>
