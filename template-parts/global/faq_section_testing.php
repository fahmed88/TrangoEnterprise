    ...
    <div class="container">
        ...
        if ($the_query->found_posts!=0)
        {
            ...
            while ( $the_query->have_posts() ) : $the_query->the_post();
                ...
                ?>
                <div class="faqCont">
                    <button type="button" class="collapsible" data-aos="fade-down" data-aos-duration="1000">
